          ...
          <InformationContainer>
            ...
            <ButtonGroupContainer>
              ...
              <button className="text-xs md:text-base bg-[#f9f9f9] text-black flex items-center justify-center py-2.5 px-6 rounded hover:bg-[#c6c6c6]">
                <img src="/images/play-icon-black.svg" alt="play_icon_black" className="h-6 md:h-8" />
              ...
              <div className="rounded-full border-2 border-white flex items-center justify-center h-11 w-11 cursor-pointer bg-black/60">
                <PlusIcon className="h-6" />
              </div>

              <div className="rounded-full border-2 border-white flex items-center justify-center h-11 w-11 cursor-pointer bg-black/60">
                <img src="/images/group-icon.svg" alt="group_icon" />
              </div>
            </ButtonGroupContainer>
...
const InformationContainer = tw.div`
  ...
  z-50
`;
const ButtonGroupContainer = tw.div`
  flex
  items-center
  space-x-3
  md:space-x-5
